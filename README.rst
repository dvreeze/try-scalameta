...
query methods, for finding specific kinds of nodes, like statements. Program *ShowSourceContents* uses both the latter
...
`Semantic model`_, support for `SemanticDB model generation`_ can easily be added to `sbt`_ projects.
